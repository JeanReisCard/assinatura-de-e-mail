		...
		<div id="divPai"   ng-controller="assCtrl">
			...
			<section id="sectionForm">
				<form id="formDados" method="get" action="/atakarejo/criaImagem1.php" >
					...
					<label id="labelTelefone">Skype:</label>
					<input type="email" name="skype" ng-model="skype" placeholder="skype@cardexpressbrasil.com.br"><br>

					<label>Celular:</label>
					<input type="tel" name="cel" ng-model="cel" placeholder=" (11) 9 0000-0000 "><br>
                    
                    <label id="labelTelefone">Telefone:</label>
					<input type="tel" name="tel" ng-model="tel" placeholder="(11) 9 0000-0000 "><br>
                    
                    <label id="labelNome">Filial:</label>
					<input type="text" name="filial" ng-model="filial" placeholder="São Paulo - SP"  id="filial"> 

					<button class="btn btn-primary"  class="small" id="btnCriarAssi" type="submit" ng-disabled="!nome || !cargo || !email || !skype" ! ng-click="limpaDados()" >Gerar Assinatura</button>
				</form> 
